        ...
        <div className="row">
          <div className="col-12 position-relative">
            ...
            <div className="juiceText">
              <h2 className="titleText text-white text-center">Fresh Fruit Juices Coming Soon</h2>
              ...
              <Link to="/juice" className="btn btn-light rounded-pill mx-auto">CHECK NOW</Link>
            </div>
          </div>
        </div>
      </div>
