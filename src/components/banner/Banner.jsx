                    ...
                    <div className="container bannerWrap">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <Link className="btn btn-success rounded-pill" to="#!"  onClick={handleScroll}>SHOP NOW</Link>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container bannerWrap">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <Link className="btn btn-success rounded-pill" href="#!" onClick={handleScroll}>SHOP NOW</Link>
                            </div>
                        </div>
                    </div>
                </div>
